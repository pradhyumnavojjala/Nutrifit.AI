...
const HomePage = () => {
  return <div className="flex flex-col min-h-screen text-foreground overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
          ...
          <div className="lg:col-span-7 space-y-8 relative">
            ...
            <p className="text-xl text-muted-foreground w2/3">
            Talk to our AI assisstant and get dite plans and workout routine just for you.
            </p>
            ...
            <div className="absolute -inset-4 pointer-events-none">
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                <div className="relative overflow-hidden rounded-lg bg-cyber-black">
                  <img src = "/AI.png" alt = "AI Fitness Coach" className="size-full object-cover object-center" />
